...
- The iCloud3 Dashboard is created and added to the *HA Sidebar* with a *Cloud* icon (<img src="../dashboard/cloud-icon-42x42.png" width="20" height="16">). A sample screen is shown below.
