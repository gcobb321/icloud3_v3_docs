...
The sensor is listed in the Excluded Sensors group. Uncheck the sensor to recreat it.
...
The screen image below, *bat* was entered to list all sensors with *bat* in the entity name (battery, battery_status).
