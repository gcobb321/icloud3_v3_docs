...
- *gary_iphone_zone_distance* - Distance to Home. I could also use *sensor.gary_iphone_home_distance* or *sensor.gary_iphone_warehouse_distance* when tracking from several zones.
