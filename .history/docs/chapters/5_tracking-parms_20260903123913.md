...
- **Log Level** - Several levels of logging are available to help provide information when trying to identify a problem. Records are added to the iCloud3 Log file (*config/icloud3.log*). This is explained further in the *Tools* chapter.
