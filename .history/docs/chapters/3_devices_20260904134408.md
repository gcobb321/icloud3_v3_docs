...
- **Device Type** (*iPhone, iPad, Watch*) - Type of the device that help identify it on the Event Log.
...
- **Zone Log Activity** - Update a csv file when the device enters a zone with the date/time, zone, and length of time in the zone. This can be used for expense reporting records. This is described in detail in the Advanced Features chapter [here]().
