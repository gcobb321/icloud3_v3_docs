...
+ I'm getting a *Custom element doesn't exist: icloud3-event-log-card* error setting up the Event Log Card +
  ...
  - Find and verify that the iCloud3 entry, */local/icloud3/icloud3-event-log-card.js* is in the list. Add it if it is not. See the *Core Component Details > Event Log* item  <a href="#/chapters/2_event-log?id=lovelace-resource-configuration">here</a> for more information.
  ...
  - **Check the value you are entering when setting up the Dashboard** - You specify the *icloud3-event-log-card* as a custom card when you add it to a Dashboard screen is `type: 'custom:icloud3-event-log-card'`.  More information about this is in the *iCloud3 Components, Event Log* documentation <a href="#/chapters/2_event-log?id=lovelace-resource-configurationg">here</a>.
