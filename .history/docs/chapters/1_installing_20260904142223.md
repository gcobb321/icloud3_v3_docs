...
6. The *iCloud3 Dashboard* is created and added to the *HA Sidebar*. Click the Cloud icon (<img src="../images2/cloud-icon-42x42.png" width="20" height="16">) to display your devices and the *Event Log*.
