...
![](../screen/parameters/device-update-tfz.png)
...
2. Add the zones to be tracked in the *Log Activity for Zones* parameter on the *Update Devices* screen for every device you want to track. You can log more than one zone at the same time.
   ...
   ![](../screen/parameters/devices-update-log-zone-activity.png)
...
![](../screen/parameters/wazehist-map-card-setup.png)
...
![](../screen/parameters/wazehist-map-dots-only.png)
