...
<br>&nbsp;&nbsp;&nbsp; ♦ <u>Distance between devices</u> - This is the calculated straight line distance between the location of both devices. 
<br>&nbsp;&nbsp;&nbsp; ♦ <u>*_home_distance* and *_zone_distance* State Value</u> -This is the driving distance from the device's last location and the Home zone or another tracked-from-zone which was returned from the Waze Route Service on the last tracking update.
