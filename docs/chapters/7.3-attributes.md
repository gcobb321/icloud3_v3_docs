...
![](../screens/attributes/attrs-device-tracker-gary.png)
...
| ---------------------------------- | ------------------------------------ |
| ![](../screens/attributes/attrs-badge.png) | ![](../screens/attributes/attrs-battery.png) |

| Travel Time, Travel Time Minutes, Arrival Time Sensor   | Arrival Time Sensor when in a zone |
| ---------------------------------- | ----------------------------------- |
| ![img](..\screens/attributes\attrs-travel-time.png) | ![img](..\screens/attributes\attrs-arrival-time.png) |

| Home Distance, Zone Distance Sensors |  |
| ---------------------------------- | ------------------------------------ |
| ![](../screens/attributes/attrs-distance.png) | ![](../screens/attributes/attrs-blank.png) |
...
![](../screens/attributes/attrs-nearby-dist-attrs.png)
...
![](../screens/attributes/attrs-nearby-dashboard.png)
