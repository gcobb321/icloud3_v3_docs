...
<br>&nbsp;&nbsp;&nbsp; ♦ <u>Distance between devices</u> - This is the straight line distance between the two locations that was calculated. 
<br>&nbsp;&nbsp;&nbsp; ♦ <u>*_home_distance* and *_zone_distance* State Value</u> -This is the driving distance between same two locations that was returned from the Waze Route server.
