...
### [a1.2.2 Creating the Event Log screen](./chapters/1.2.2-creating-event-log-screen.md)

### [a1.2.3 Lovelace Resource for the Event Log](./chapters/1.2.3-event-log-lovelace-resource.md)

### [a1.2.4 Event Log During iCloud3 Startup](./chapters/1.4-evlog-during-startup.md)



### 1.2.2 Creating the Event Log screen  <!-- {docsify-ignore} -->
...
### 1.2.3 Lovelace Resource for the Event Log  <!-- {docsify-ignore} -->
