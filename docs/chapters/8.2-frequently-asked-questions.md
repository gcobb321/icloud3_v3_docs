...
-Go to <i>Settings App > Privacy and Security > Location Services - Share My Location</i>. Location Sharing should be enabled.
- Go to <i>FindMy App > Me</i> Location field should not be showing ‘Not Sharing Location’.
</details>
