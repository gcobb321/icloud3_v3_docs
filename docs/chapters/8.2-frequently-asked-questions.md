...
<details><summary>App Specific Passwords 111b</summary>
...
<details><summary>My iPad is listed on the FindMy App but it is not listed in the Family Sharing device list in iCloud3</summary>
Location sharing is probablynot enabled on the iPad:
<br>• Go to <i>Settings App > Privacy and Security > Location Services - Share My Location</i>. Location Sharing should be enabled.
<br>• Go to <i>FindMy App > Me</i> Location field should not be showing ‘Not Sharing Location’.
</details>
