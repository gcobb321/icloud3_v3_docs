...
3. Copy all of the code in the above code block and past it into the Edit Configuration window. Then select **Save**, then select the '**X**' next to Edit Configuration in the upper-left, then select **Done**.
