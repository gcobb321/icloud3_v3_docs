...
2. Install and configure the HA Companion App (iOS App) if you are using it on any of your tracked devices. 
...
6. Open the *iCloud Account & iOS App Data Sources* screen and set up your Apple iCloud account.
