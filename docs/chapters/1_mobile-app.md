...
3. Tap **Debugging > Clear Web View Cache or Reset Frontend Cache**
4. Tap **Settings > Done**
5. Refresh the screen by pulling down on it until the refresh symbol displays. This will reload the screen and iCloud3 Event Log from the HA server.
