## iCloud3 User Guide Index  {docsify-ignore}
...
- [Lovelace Resource for the Event Log](https://gcobb321.github.io/icloud3_v3_docs/#/chapters/2.3-ios-app?id=assigning-the-ios-app-device)
  - [Using another custom card directory](chapters/1.2-event-log?id=using-another-custom-card-directory)
- [Event Log During Startup](https://gcobb321.github.io/icloud3_v3_docs/#/chapters/1.2-event-log?id=event-log-during-startup)
  ...
  - [Stage 4 - Setup iCloud & iOS App Tracking Methods](chapters/1.2-event-log?id=stage-4-setup-icloud-amp-ios-app-tracking-methods)
...
- [Typical Configure Settings screens](https://gcobb321.github.io/icloud3_v3_docs/#/chapters/1.3-configure-settings?id=typical-configure-settings-screens)
...
- [iCloud Account Family Sharing Devices (FamShr)](https://gcobb321.github.io/icloud3_v3_docs/#/chapters/2.1-icloud-account?id=icloud-account-family-sharing-devices-famshr)
  - [Configuring the iCloud Account as a Data Source](https://gcobb321.github.io/icloud3_v3_docs/#/chapters/2.1-icloud-account?id=configuring-the-icloud-account-as-a-data-source)
...
- [Login email Notification from Apple](https://gcobb321.github.io/icloud3_v3_docs/#/chapters/2.3-ios-app?id=configuring-the-ios-app-as-a-data-source)
...
- [Configuring the iOS App as a Data Source](https://gcobb321.github.io/icloud3_v3_docs/#/chapters/2.3-ios-app?id=configuring-the-ios-app-as-a-data-source)
    - [Enable HA iOS Companion App data usage](chapters/2.3-ios-app?id=enable-ha-ios-companion-app-data-usage)

- [Assigning the iOS App Device](https://gcobb321.github.io/icloud3_v3_docs/#/chapters/2.3-ios-app?id=assigning-the-ios-app-device)
...
- [Upgrading to iCloud3 v3](https://gcobb321.github.io/icloud3_v3_docs/#/chapters/3.1-migrating-v2-to-v3?id=upgrading-to-icloud3-v3)
...
- [Step 3 - Review the Parameter Migration Results](chapters/3.2-installing-and-configuring?id=clearing-the-browser39s-cache)
  - [Step #3.1 - The *iCloud Account & iOS App* screen](https://gcobb321.github.io/icloud3_v3_docs/#/chapters/3.2-installing-and-configuring?id=step-3-add-the-icloud3-integration-and-open-configure-settings)
...
- [Step #5 - Clear the Browsers Cache](https://gcobb321.github.io/icloud3_v3_docs/#/chapters/3.2-installing-and-configuring?id=step-5-set-up-a-lovelace-card-tracking-card)
...
- [Step #3 - Add the iCloud3 Integration and open *Configure Settings*](https://gcobb321.github.io/icloud3_v3_docs/#/chapters/3.2-installing-and-configuring?id=step-3-add-the-icloud3-integration-and-open-configure-settings)
...
- [Step #4 - Exit the *Configure Settings* screens and Restart iCloud3](https://gcobb321.github.io/icloud3_v3_docs/#/chapters/3.2-installing-and-configuring?id=step-3-add-the-icloud3-integration-and-open-configure-settings)
  - [The Other Configuration Screens](chapters/3.2-installing-and-configuring?id=the-other-configuration-screens)
- [Step #5 - Set up a Lovelace card tracking card](https://gcobb321.github.io/icloud3_v3_docs/#/chapters/3.2-installing-and-configuring?id=step-5-set-up-a-lovelace-card-tracking-card)
...
- [Clearing the Browser's Cache](https://gcobb321.github.io/icloud3_v3_docs/#/chapters/3.2-installing-and-configuring?id=clearing-the-browser39s-cache)
...
- [Special Zones](https://gcobb321.github.io/icloud3_v3_docs/#/chapters/7.1-config-parms?id=special-zones)
...
- [Display the Waze History Locations on a Map Card](https://gcobb321.github.io/icloud3_v3_docs/#/chapters/7.2-other-topics?id=display-the-waze-history-locations-on-a-map-card)
...
- [iCloud3 General Questions:](https://gcobb321.github.io/icloud3_v3_docs/#/chapters/7.2-other-topics?id=display-the-waze-history-locations-on-a-map-card)
