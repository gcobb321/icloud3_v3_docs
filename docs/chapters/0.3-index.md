...
- [Lovelace Resource for the Event Log]chapters/2.3-ios-app?id=assigning-the-ios-app-device)
...
- [Assigning the iOS App Device]chapters/2.3-ios-app?id=assigning-the-ios-app-device)
