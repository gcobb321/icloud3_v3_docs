...
<p>The Developers Edition is used to distribute prerelease/beta code for testing before it is released for general use. It is available on HACS as a custom repository. The following describes how to add the custom repository to HACS. </p>
<ol>
