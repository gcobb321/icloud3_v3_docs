...
HACS displays information about the version of iCloud3 it has downloaded. HACS keeps that version number in it's database to be able to identify when an update is available. </p>
<p>​    <img src="../icloud3_v3_docs/images/version-hacs.png"></p>
...
<p>​    <img src="../icloud3_v3_docs/images/version-running.png"></p>
</details>
