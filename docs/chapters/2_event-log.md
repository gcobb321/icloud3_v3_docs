...
- Start Waze History maintenance operations
  ...
  ![](../screens/evlog/evlog-actions.png)
...
![](../screens/evlog/evlog-stage-1.png)
...
![](../screens/evlog/evlog-stage-2.png)
...
![](../screens/evlog/evlog-stage-3.png)
...
![](../screens/evlog/evlog-stage-4.png)
...
![](../screens/evlog/lovelace-evlog-resource-error.png)
...
1. Select **☰ > HA Settings > Dashboards > ⋮ (Upper right corner) > Resources**. The following screen is displayed:
   ...
   ![](../screens/evlog/lovelace-resources-list.png)

2. Select **+ Add Resource** to open the Add Resources window (on the left).

   ![](../screens/evlog/lovelace-resources-add.png)
