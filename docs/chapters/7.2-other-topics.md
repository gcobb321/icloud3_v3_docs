...
2. Add the following to your `configuration.yaml` file and restart Home Assistant.
   ...
   Change the path if you have moved the *card-mod.js* file to another location. The _card_mod_ docs show it being installed in *hacsfiles* but if you installed through HACS, it is probably in the *www/community/lovelace-card-mod/* directory. 
