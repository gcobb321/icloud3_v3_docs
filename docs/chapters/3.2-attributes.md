...
| Device Tracker Entity                       | Badge Sensor                       | Battery Sensor                       |
| ---------------------------------- | ------------------------------------ | ----------------------------------------- |
| ![](../images/attrs_device_tracker_300.png) | ![](../images/attrs_badge_300.png) | ![](../images/attrs_Battery_300.png) |


| Arrival Time Sensor                       | Travel Time Sensors | Distance Sensors                      |
| ---------------------------------- | ------------------------------------ | ----------------------------------------- |
| ![](../images/attrs_arrival_time_300.png) | ![](../images/attrs_travel_time_300.png) | ![](../images/attrs_distance_300.png) |


| Distance Moved Sensor                       | Interval Sensor                       | Located, Next Update & Last Update Sensors |
| ---------------------------------- | ------------------------------------ | ----------------------------------------- |
| ![](../images/attrs_dist_moved_300.png) | ![](../images/attrs_interval_300.png) | ![](../images/attrs_located_300.png) |
