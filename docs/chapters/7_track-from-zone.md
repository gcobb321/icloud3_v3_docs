...
To track from another zone, select that zone in the *Track from Zones* parameter on the *iCloud3 Devices > Update iCloud3 Device > Update Other Device Parameters* screen.

1. Select the *iCloud3 Devices > Update iCloud3 Device > Update Other Device Parameters* screen.
2. Select the *Track-from-Zones* field, then select the zones to be tracked from.
3. Then select *Save*, then *Submit*.

![](../screens/parameters/track-from-zones-sel-list.png)
...
- **Sensor's Friendly Name** - The zone's display-as friendly name is added to the end of the sensor friendly name:
...
- Other zone's information is displayed - Its first initial is displayed in the *distance* sensor (🅦 is shown for the Warehouse zone).
