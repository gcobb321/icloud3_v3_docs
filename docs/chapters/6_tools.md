...
*Log Level Device Filter* - Rawdata logs all of the traffic between the Apple accounts and iCloud3. The amount of data can sometimes make it difficult to analyze and find the information needed to solve an issue or see how it is being processed. This filter is used to limit the data being logged to specific devices.

![](../screens/tools/log-level.png)

#### iCloud3 Log File
The following drop-down items (Info, Debug, Rawdata) show examples of the iCloud3 Log file.
...
![](../screens/tools/cleanup-sensors.png)
